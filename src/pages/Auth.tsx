...
const Auth = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-white to-grey/30 flex items-center justify-center px-4">
            ...
            <TabsContent value="login" className="space-y-4">
              <Form {...loginForm}>
                <form onSubmit={loginForm.handleSubmit(onLogin)} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-maroon hover:bg-maroon/90" disabled={isLoading}>
