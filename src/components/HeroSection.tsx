...
const HeroSection = () => {
  return (
    <section className="pt-28 pb-20 bg-gradient-to-br from-white to-grey/30 min-h-[90vh] flex items-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="absolute -bottom-10 -right-5 bg-white p-4 rounded-2xl shadow-lg -rotate-3 animate-float" style={{animationDelay: "0.5s"}}>
